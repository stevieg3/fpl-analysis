...
mms = _load_model_from_pickle('src/models/pickles/min_max_scalar_lstm.pickle')
COLUMNS_TO_SCALE = _load_model_from_pickle('src/models/pickles/min_max_scalar_columns.pickle')
