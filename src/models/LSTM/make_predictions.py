...
full_data = _load_input_data(previous_gw=20, save_file=True)
...
final_predictions.to_parquet('data/gw_predictions/gw21_v3_lstm_player_predictions.parquet', index=False)
