...
full_data = _load_input_data(previous_gw=12, save_file=True)
...
final_predictions.to_parquet('data/gw_predictions/gw13_v2_lstm_player_predictions.parquet', index=False)
