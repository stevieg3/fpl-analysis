...
full_data = _load_input_data(previous_gw=11, save_file=True)
...
final_predictions.to_parquet('data/gw_predictions/gw12_v2_lstm_player_predictions.parquet', index=False)
